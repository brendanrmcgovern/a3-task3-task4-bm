...
###iii. From the summary table, we can see that the Purple Urchin popultion is on average smaller than the Red Urchin population. The Purple Urchin population is less dispersed and generally smaller in diamater. The Purple Urchin population has a slight positive skew, smaller standard deviation and a narrower dispersion. The Red Urchin population has a more normal distribution, larger standard deviation and wider dispersion. The urchin population have a mean difference of 2.306692

##b. Section 2: Explore purple urchin counts by site and year
###i. Create purple_urchins: and then filter to only include for purple urchins, convert the date to class "Date", creat a new column called site_full that contains the full names for the sites
```{r, echo = TRUE, message = FALSE, warning = FALSE}
